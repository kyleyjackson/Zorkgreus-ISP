...
public class demolisionistSkeletons extends Boss {
    ...
    public void displayBossMessage() {
        System.out.println(
                "Two skeletons carrying a bagful of bombs on their back look at you with glee in their eyes as they start to laugh maniacally. As they start to juggle those bombs around, they gesture for you to come");
    }
